...
const RAW_EVENTS = {
    1: [
        ...
        { t: "第一场吻戏，导演问要不要借位。", i: "💋", o: [
            { t: "要求真亲", e: { sugar: 50, bond: 8, risk: 12 } },
    ...
    2: [
        ...
        { t: "双人杂志拍摄，摄影师要求鼻尖碰鼻尖。", i: "📸", o: [
            { t: "真的亲到了", e: { sugar: 85, bond: 18, risk: 25, solo: -40 } },
    ...
    3: [
        ...
        { t: "对家发通稿黑你“吸血”，数据难看。", i: "📉", o: [
            ...
            { t: "发CP糖回击", e: { sugar: 50, bond: 8, solo: -18 } },
