...
const PHASE_CONFIG = [
    ...
    { 
        id: 4, name: "宣发预热期", 
        kpis: [ { type: 'cp', target: 60, label: 'CP热度' }, { type: 'play', target: 100, label: '预告播放（百万）' } ],
        desc: "“买热搜、炒CP，一切为了首播数据。”" 
    },
    { 
        id: 5, name: "上线播出期", 
        kpis: [ { type: 'play', target: 180, label: '播放量（百万）' }, { type: 'money', target: 300, label: '粉丝氪金' } ],
...
const RAW_EVENTS = {
    ...
    4: [
        ...
        { t: "宣发期，平台要求限制CP营销，避免合规风险。", i: "📢", o: [
            { t: "听从要求，主打剧情向宣发", e: { risk: -8, cp: -20, play: 30 } },
        ...
        { t: "宣发预算不足，无法购买热搜和推广位。", i: "💰", o: [
            ...
            { t: "削减制作成本，追加宣发预算", e: { play: 30, cp: 20, money: -150 } }
        ]},
        ...
        { t: "竞品剧买水军刷黑评，抹黑你的剧“剧情拉胯”。", i: "🖤", o: [
            ...
            { t: "无视黑评，专注自家宣发", e: { risk: -5, play: 15, cp: 5 } },
        ...
        { t: "短视频平台限流所有CP相关物料，播放量骤降。", i: "📱", o: [
            ...
            { t: "买通平台运营，恢复流量", e: { money: -200, play: 50, risk: 10, cp: 20 } },
    ...
    5: [
        ...
        { t: "播出后，播放量破亿，但合规风险预警升级。", i: "📈", o: [
            ...
            { t: "继续播出，找关系压下风险", e: { risk: 25, play: 50, money: -200 } },
            { t: "减少营销，低调播出", e: { risk: 5, play: 20, cp: -15 } }
        ]},
        ...
        { t: "平台要求加更，但制作方赶不上进度。", i: "⏩", o: [
            { t: "加班赶制，满足加更要求", e: { platform: 20, play: 50, money: -50 } },
        ...
        { t: "播出后，弹幕/评论区被平台屏蔽“CP”“耽美”等关键词。", i: "🚫", o: [
            { t: "配合平台，引导粉丝聊剧情/演技", e: { risk: -8, cp: -10, play: 50 } },
        ...
        { t: "抽查发现剧中有“不合规背景音乐”，要求下线整改。", i: "🎵", o: [
            ...
            { t: "深夜偷偷上线，不整改", e: { risk: 25, play: 50, platform: -12 } },
            { t: "找专家背书，证明音乐合规", e: { money: -150, risk: 5, play: 30 } }
        ]},
        { t: "播出期间，双男主唯粉互撕上热搜，影响剧集口碑。", i: "⚔️", o: [
            { t: "发声明呼吁理性，暂停双人营业", e: { cp: -15, risk: -5, money: -30 } },
            { t: "引导CP粉控评，压下唯粉节奏", e: { cp: 30, risk: 8, money: -80 } },
            { t: "无视撕逼，靠剧集质量翻盘", e: { play: 15, cp: -5, platform: 5 } }
        ]},
        { t: "平台要求提高会员价格，包含独家花絮，否则减少推荐位。", i: "💎", o: [
            { t: "答应提价，增加独家CP花絮", e: { money: 300, cp: 15, risk: 10 } },
            { t: "拒绝提价，放弃推荐位", e: { play: -20, platform: -10, money: 0 } },
            { t: "提价但只加剧情花絮", e: { money: 100, cp: -5, risk: -3 } }
        ]},
        { t: "品牌方找上门，想签双男主代言并增加剧情植入。", i: "🧑‍💼", o: [
            { t: "接双人代言+深度植入", e: { money: 300, cp: 20, risk: 10 } },
            { t: "只接单人代言+少量植入", e: { money: 150, cp: -5, platform: 5 } },
            { t: "拒绝代言，只接小额广告植入", e: { money: 80, risk: -5, play: 5 } }
        ]},
        { t: "平台提议开通付费点播大结局，分成比例诱人。", i: "🔒", o: [
            { t: "同意，提前解锁付费点播", e: { money: 250, play: 30, cp: 10, risk: 8 } },
            { t: "拒绝，免费播出", e: { money: -20, platform: -5, risk: -5 } },
            { t: "折中，延迟一周付费点播", e: { money: 120, play: 10, cp: 5, risk: 3 } }
        ]},
        { t: "海外平台想买版权，出价很高但要求删减部分内容。", i: "🌐", o: [
            { t: "同意出售，按要求删减", e: { money: 400, risk: -15, cp: -20 } },
            { t: "拒绝删减，低价出售", e: { money: 100, play: 20, risk: 5 } },
            { t: "只卖非CP向剪辑版", e: { money: 200, cp: -10, risk: -8, play: 15 } }
        ]},
        { t: "粉丝要求推出官方周边（立牌/海报/礼盒），利润可观。", i: "🛍️", o: [
            { t: "大量推出CP向周边", e: { money: 350, cp: 25, risk: 12 } },
            { t: "只推出单人周边", e: { money: 180, cp: -8, platform: 5 } },
            { t: "少量推出剧情向周边", e: { money: 100, cp: 5, risk: 3, play: 8 } }
        ]},
        { t: "广告商想追加植入，愿意加钱但要求剧情露脸更多。", i: "📺", o: [
            { t: "同意追加，增加广告镜头", e: { money: 280, platform: 15, play: -5 } },
            { t: "少量追加，不影响剧情", e: { money: 150, platform: 8, play: 5 } },
            { t: "拒绝追加，保证观剧体验", e: { money: -30, platform: -5, risk: -5 } }
        ]}
    ],
    6: [
        // 原事件保留
        ...
        { t: "剧的最终收益分配，演员要求提高分成。", i: "💰", o: [
            { t: "答应提高分成，留住演员", e: { money: -150, cp: 20, platform: 5 } },
            { t: "拒绝，更换演员拍续集", e: { cp: -25, play: -10, platform: -5 } },
            { t: "折中，少量提高分成", e: { money: -80, cp: 10, platform: 5 } }
        ]},
// 保留「粉丝要求拍第二季」事件，但去掉它的 end 类型（避免多结局入口）
{ t: "粉丝要求拍第二季，延续CP故事线。", i: "📝", o: [
    { t: "启动第二季筹备，延续CP线", e: { cp: 45, risk: 30, money: -200 } }, // 去掉 end: 'continue'
    { t: "拒绝第二季，专注新剧", e: { cp: -20, platform: 10, risk: -5 } }, // 去掉 end: 'new'
    { t: "拍第二季但更换CP，规避风险", e: { cp: 10, risk: 10, money: -100 } }
]},
// 「终局抉择」事件仅保留3个 end 类型（boom/turn/wait），作为唯一结局入口
{ t: "【终局抉择】你的双男主剧成为年度爆款，但合规风险仍在。", i: "🏆", o: [
    { t: "乘胜追击，继续拍双男主剧", e: { end: 'boom', play: 50, risk: 40, money: 500 } }, // 仅保留 end: 'boom'
    { t: "转型主流剧，远离该题材", e: { end: 'turn', risk: -20, platform: 30, cp: -30 } }, // 仅保留 end: 'turn'
    { t: "暂停新项目，观望风向", e: { end: 'wait', risk: -10, money: 100, cp: -5 } } // 仅保留 end: 'wait'
]},
        // 新增事件（售后营业期）
        ...
        { t: "资方要求双男主解绑后“互撕”炒热度，提升商务价值。", i: "👊", o: [
            ...
            { t: "表面互撕，私下和解", e: { play: 15, cp: -10, risk: 8 } }
        ]},
...
function startGame() {
    ...
    state.stats.money = 700 + (state.attrs.fan * 50);
...
function loadEvent() {
    ...
    if (state.phase === 6) {
        ...
        // 注意：在你的代码中，【终局抉择】是第6阶段数组里的第 3 个事件（索引为3） 这里不对 因为没有end
        if (state.week === 5) {
    ...
    if (available.length === 0) {
        // 第6阶段没题了就直接进结局
        if (state.phase === 6) { renderEvent(RAW_EVENTS[6][5]); return; }
...
function calcEnding(type) {
    ...
    // 原有所有结局完整保留（一个都不删）
    if(type === 'boom' && play > 700 && risk < 60) {
        id = 1;
        title = "🏆 双男主顶流剧王";
        desc = "你的剧成为年度爆款，播放量破百亿，CP热度屠榜。\n虽然合规风险仍在，但你已是双男主101的最终赢家，资方追投10亿启动新剧。";
    } else if (type === 'boom' && cp > 200 && risk < 50) { // 新增：boom 类型下触发 CP 捆绑结局
        id = 2;
        title = "🔗 CP捆绑天花板";
        desc = "你成功续约双人商务，成为内娱CP营业标杆。\n粉丝氪金超千万，资方赚得盆满钵满，但两位主演永远活在题材标签下。";
    } else if (type === 'boom' && play > 400 && cp < 100) { // 新增：boom 类型下触发单飞结局
        id = 3;
        title = "🌟 单飞转型成功";
        desc = "你果断解绑CP，让演员转型主流影视剧。\n虽然失去了CP红利，但规避了合规风险，演员事业更上一层楼。";
    } else if (type === 'boom' && cp > 100 && risk < 70) { // 新增：boom 类型下触发第二季结局
        id = 4;
        title = "📝 第二季启动";
        desc = "你顶住合规压力启动第二季，延续原班人马CP线。\n首播播放量破亿，但合规风险持续走高，随时可能下线。";
    } else if (type === 'turn' && platform > 80 && risk < 40) { // turn 类型下触发转战主流赛道
        id = 6;
        title = "🎬 转战主流赛道";
        desc = "你放弃续集，专注打造正能量主流剧。\n平台给予顶级推荐位，虽然少了CP热度，但项目稳赚不赔。";
    } else if (type === 'turn' && risk < 30 && platform > 90) { // turn 类型下触发主流顶流制作人
        id = 7;
        title = "🚀 主流顶流制作人";
        desc = "你彻底远离该题材，转型制作主旋律剧集。\n获得官方认可，成为业内标杆，再也不用担惊受怕合规风险。";
    } else if (type === 'wait' && money > 600) { // wait 类型下触发持币观望
        id = 8;
        title = "💤 持币观望";
        desc = "你手握千万现金流，暂停所有新项目静待行业风向。\n同行纷纷踩雷时，你稳坐钓鱼台，等待最佳入局时机。";
    } else if (type === 'boom' && cp > 180 && play < 300 && risk < 60) { // boom 类型下触发二创区顶流
        id = 11;
        title = "🎭 二创区野生顶流";
        desc = "剧集本身播放量拉胯，但CP二创横扫各大平台，剪辑、同人、整活视频播放量破亿。\n官方摆烂躺平，全靠网友自来水续命，你直接摆烂卖二创授权赚翻。";
    } else if (type === 'boom' && play > 500 && cp < 50 && risk > 50) { // boom 类型下触发魔改反噬
        id = 12;
        title = "🗡️ 魔改剧情遭反噬";
        desc = "为规避合规风险魔改核心剧情，把兄弟情改成狗血三角恋。\n原著粉和CP粉集体抵制，播放量断崖式下跌，平台连夜下架整改。";
    } else if (type === 'boom' && play > 300 && cp > 150 && platform < 40 && risk < 70) { // boom 类型下触发墙外开花
        id = 13;
        title = "🌏 墙外开花墙内香";
        desc = "国内播放量平平无奇，却意外火遍东南亚和欧美。\n海外粉丝氪金打赏超千万，你干脆放弃内娱市场，专心做海外发行。";
    } else if (type === 'boom' && risk > 70 && money > 600 && play > 300) { // boom 类型下触发AI换脸
        id = 14;
        title = "🤖 AI换脸极限续命";
        desc = "核心演员踩雷导致合规风险爆表，你砸重金用AI换脸替换所有镜头。\n剧集如期上线，虽然画质一言难尽，但好歹收回了成本。";
    } else if (type === 'boom' && cp > 150 && play < 200 && money > 300) { // boom 类型下触发综艺续命
        id = 15;
        title = "🎤 综艺续命挽狂澜";
        desc = "剧集扑街但CP还有点热度，你紧急上线衍生团综。\n两位主演公费营业狂撒糖，综艺播放量反超正片，靠广告和会员费赚得盆满钵满。";
    } else if (type === 'turn' && risk < 10 && platform > 95 && play > 400) { // turn 类型下触发官方认证
        id = 16;
        title = "🏅 官方认证根正苗红";
        desc = "你把双男主剧情改成正能量职场剧，合规风险几乎为零。\n剧集被广电点名表扬，成为行业示范案例，平台直接签了三年独家合作。";
    } else if (type === 'boom' && play > 400 && cp > 200 && money < 100 && risk > 60) { // boom 类型下触发主演塌房
        id = 17;
        title = "💣 主演塌房一锅端";
        desc = "剧集刚爆火，主演就被曝重大丑闻，合规风险瞬间拉满。\n平台紧急下架，广告商集体解约，你不仅血本无归，还得赔偿违约金。";
    } else if (type === 'boom' && play > 400 && risk > 60 && cp > 100 && platform < 60) { // boom 类型下触发黑红也是红
        id = 18;
        title = "🔥 黑红也是红";
        desc = "你故意放出争议剧情片段制造话题，靠“烂出圈”吸引流量。\n虽然骂声一片，但播放量和氪金数据暴涨，赚够了热度就宣布停更跑路。";
    } else if (type === 'wait' && play < 200 && money > 700 && risk < 40) { // wait 类型下触发小成本赚钱
        id = 19;
        title = "💰 小成本闷声发大财";
        desc = "你放弃大制作，用低成本拍小甜饼番外，靠付费点播和周边赚钱。\n虽然没爆火，但投入产出比高达10:1，资方直呼内行。";
    } else if (type === 'boom' && cp > 100 && risk > 40 && money < 150) { // boom 类型下触发粉丝大战
        id = 20;
        title = "⚔️ 粉丝大战逼停项目";
        desc = "两家唯粉为争番位互撕三个月，举报对方偶像和剧集违规。\n平台不堪其扰，直接暂停剧集更新，你的项目彻底凉凉。";
    } else if (risk >= 80) { // 兜底：合规踩雷
        id = 9;
        title = "⚠️ 合规红线踩雷";
        desc = "合规风险居高不下，你的项目被列入重点监管名单。\n所有宣发被叫停，剧集无限期积压，血本无归。";
    } else if (play < 250 && money < 200) { // 兜底：扑街小糊剧
        id = 10;
        title = "💸 扑街小糊剧";
...
// ✅ 新增选项 1：工业糖精包 (增加 CP 热度，针对第4阶段KPI)
    if(t==='cp') { 
        cost=150; 
        eff={cp: 50}; 
    }

    // ✅ 新增选项 2：强力洗白 (更贵的降低风险，针对第1、3阶段)
    if(t==='super_risk') { 
        cost=400; 
        eff={risk: -40}; 
    }
